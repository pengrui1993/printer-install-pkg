    ...
    for(auto& info :QPrinterInfo::availablePrinters() ){
        if(info.printerName().startsWith("POS58 Printe")){
            ...
            if(p.begin(&printer)){
                ...
                //p.drawText(0,60,"XXXX门店 http://localhost:8080");
